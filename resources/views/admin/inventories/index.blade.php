                        ...
                        <div class="card-body">
                            ...
                            @if ($inventories->isEmpty())
                                ...
                                <div class="col-12 text-center">
                                    <img src="{{ asset('img/inventaris.png') }}" alt="Menu tidak ditemukan"
                                        style="max-width: 300px;" class="img-fluid mb-3">
                                    <h5 class="text-muted" style="margin-top: -60px;">Oops! Inventaris Kosong.</h5>
                                    <p class="text-muted">kamu belum memiliki inventaris untuk saat ini. Silakan tambah
                                        inventaris baru
                                    </p>
                                </div>
                            @else
                                                ...
                                                <td>
                                                    <div style="display: flex; gap: 10px;">
                                                        <button class="btn btn-primary edit-btn"
                                                            data-id="{{ $inventory->id }}" data-toggle="modal"
                                                            data-target="#editInventoryModal">Edit</button>
