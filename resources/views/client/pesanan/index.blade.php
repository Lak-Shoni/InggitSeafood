        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                ...
                <div class="mb-3">
                    ...
                    <input type="datetime-local" class="form-control" id="delivery_time" name="delivery_time" required min="{{ Carbon\Carbon::now()->format('Y-m-d\Th:i:s') }}" value="{{ Carbon\Carbon::now()->format('Y-m-d\Th:i:s') }}">
                </div>
                <div class="mb-5">
                ...
                <div class="mb-3" id="due_date_container" style="display: none;">
                    ...
                    <input type="datetime-local" class="form-control" id="due_date" name="due_date" min="{{ Carbon\Carbon::now()->format('Y-m-d\Th:i:s') }}" value="{{ Carbon\Carbon::now()->format('Y-m-d\Th:i:s') }}">
                </div>
            ...
            <tbody>
                @foreach($carts as $cart)
                    <tr>
                        ...
                        <td class="total" data-id="{{ $cart->id }}">Rp. {{ number_format($cart->total_per_item,0,",",".") }}</td>
